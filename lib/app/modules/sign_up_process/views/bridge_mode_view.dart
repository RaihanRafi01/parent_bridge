...
class BridgeModeView extends GetView<SignUpProcessController> {
  const BridgeModeView({super.key});
  @override
  Widget build(BuildContext context) {
    Get.put(SignUpProcessController());
    final authController = Get.find<AuthenticationController>();
    final shareableCode =
        authController.onboardingResponse?.data.shareableCode ?? '';
            ...
            return SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  //       GestureDetector(
                  //         onTap: () {
                  //           controller.isSendInvite.value = false;
                  //         },
                  //         child: Container(
                  //           padding: EdgeInsets.symmetric(
                  //             horizontal: 53.w,
                  ...
                  //             gradient: LinearGradient(
                  //               colors: [
                  //                 controller.isSendInvite.value
                  //                     ? AppColors.clrTransparent
                  ...
                  //       GestureDetector(
                  //         onTap: () {
                  //           controller.isSendInvite.value = true;
                  //         },
                  //         child: Container(
                  //           padding: EdgeInsets.symmetric(
                  //             horizontal: 53.w,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    if (shareableCode.isNotEmpty) {
                                      Clipboard.setData(
                                        ClipboardData(text: shareableCode),
                                      );
                                      kSnackBar(
                                        title: "Copied",
                                        message:
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomTextField(
                                  ...
                                  prefixIcon:
                                      'assets/images/sign_up_process/co_parent.svg',
                                  controller:
                                ...
                                CustomTextField(
                                  ...
                                  prefixIcon:
                                      'assets/images/sign_up_process/phone_number.svg',
                                ...
                                CustomTextField(
                                  ...
                                  prefixIcon:
                                      'assets/images/sign_up_process/email.svg',
                                ...
                                CustomTextField(
                                  ...
                                  prefixIcon:
                                      'assets/images/sign_up_process/state.svg',
